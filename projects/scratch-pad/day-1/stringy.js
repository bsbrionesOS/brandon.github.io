...
function toUpperCase(string) {
    // YOUR CODE BELOW HERE //
    //returning string to uppercase using toUpperCase()
...
function beginsWith(string, char) {
    // YOUR CODE BELOW HERE //
//using an if statement to compare the the first letter of the string -by [0]- with a given character
//to make it case insensitive I made the first letter of the string and character UpperCase to be compared equally
