...
function greeter(hour) {
    ...
    /*making conditional statement that make the given number 0-11 console.log 'Good Morning!'
    12-16 console.log('Good Afternoon') 17-21 console.log('Good Evening') 22-24 console.log('Good Night')
    */
  if(hour >= 0 && hour < 12){
